...
if ($polaczenie->connect_errno != 0) {
    ...
    $query = "SELECT * FROM produkty WHERE typ = 'warzywo'";
    ...
    echo '<title>Warzywa - Sklep</title>';
    echo '</head>';
    echo '<body>';

    echo '<a href="stronag.php"><h2>Warzywa</h2>';
    echo '<div class="cart">';
    ...
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<input type="hidden" name="produkt_typ" value="warzywo">'; // Nowe pole do 
